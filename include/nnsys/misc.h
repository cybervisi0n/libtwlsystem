...
#define NNS_ASSERT(exp)                                                        \
  (void)((exp) ||                                                              \
         (OSi_Panic(__FILE__, __LINE__, "NNS:Failed assertion " #exp), 0))
#endif
#else // NNS_DEBUG
#ifndef NNS_ASSERT
...
#define NNS_NULL_ASSERT(exp)                                                   \
  (void)((exp != NULL) ||                                                      \
         (OSi_Panic(__FILE__, __LINE__,                                        \
                    "NNS:Pointer must not be NULL (" #exp ")"),                \
          0))
#endif
#else // NNS_DEBUG
#ifndef NNS_NULL_ASSERT
...
#define NNS_MAX_ASSERT(exp, max)                                               \
  (void)(((exp) <= (max)) || (OSi_Panic(__FILE__, __LINE__,                    \
                                        #exp " is out of bounds(%d)\n" #exp    \
                                             " <= %d not satisfied.",          \
                                        exp, max),                             \
                              0))
...
#define NNS_ALIGN4_ASSERT(exp)                                                 \
  (void)((((u32)exp & 3) == 0) ||                                              \
         (OSi_Panic(__FILE__, __LINE__,                                        \
                    "NNS:Alignment Error(0x%x)\n" #exp                         \
                    " must be aligned to 4 bytes boundary.",                   \
                    exp),                                                      \
          0))
#endif
#else // NNS_DEBUG
...
#define NNS_ALIGN2_ASSERT(exp)                                                 \
  (void)((((u32)exp & 1) == 0) ||                                              \
         (OSi_Panic(__FILE__, __LINE__,                                        \
                    "NNS:Alignment Error(0x%x)\n" #exp                         \
                    " must be aligned to 2 bytes boundary.",                   \
                    exp),                                                      \
          0))
#endif
#else // NNS_DEBUG

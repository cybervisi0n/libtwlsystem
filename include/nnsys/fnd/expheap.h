...
struct NNSiFndExpMBlockList {
  ...
  NNSiFndExpHeapMBlockHead *tail; // Pointer to the memory block linked to the
                                  // tail of the expanded heap
};
...
typedef void (*NNSFndHeapVisitor)(void *memBlock, NNSFndHeapHandle heap,
                                  u32 userParam);

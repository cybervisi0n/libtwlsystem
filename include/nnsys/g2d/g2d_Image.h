...
NNS_G2D_INLINE BOOL NNS_G2dIsPaletteImageFmt(const NNSG2dImageAttr *imgAttr) {
  ...
  return (imgAttr->fmt == GX_TEXFMT_PLTT4 || imgAttr->fmt == GX_TEXFMT_PLTT16 ||
          imgAttr->fmt == GX_TEXFMT_PLTT256)
             ? TRUE
             : FALSE;
}

NNS_G2D_INLINE void NNS_G2dSetImageExtPaletteFlag(NNSG2dImageProxy *pImgProxy,
                                                  BOOL bUseExtPlt) {

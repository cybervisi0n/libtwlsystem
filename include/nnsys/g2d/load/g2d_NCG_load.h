...
BOOL NNS_G2dGetUnpackedCharacterPosInfo(void *pNcgrFile,
                                        NNSG2dCharacterPosInfo **ppCharPosInfo);

#ifdef __SNC__
NNS_G2D_DEBUG_FUNC_DECL_BEGIN void
NNS_G2dPrintCharacterData(const NNSG2dCharacterData *p1)
...
#else
NNS_G2D_DEBUG_FUNC_DECL_BEGIN void
NNS_G2dPrintCharacterData(const NNSG2dCharacterData *)
    NNS_G2D_DEBUG_FUNC_DECL_END NNS_G2D_DEBUG_FUNC_DECL_BEGIN
    void NNS_G2dPrintCharacterPosInfo(const NNSG2dCharacterPosInfo *)
        NNS_G2D_DEBUG_FUNC_DECL_END
#endif

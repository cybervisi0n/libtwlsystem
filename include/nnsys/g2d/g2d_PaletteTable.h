...
void NNS_G2dSetPaletteTableValue(NNSG2dPaletteSwapTable *pPlttTbl,
                                 u16 beforeIdx, u16 afterIdx);
u16 NNS_G2dGetPaletteTableValue(const NNSG2dPaletteSwapTable *pPlttTbl,
                                u16 beforeIdx);

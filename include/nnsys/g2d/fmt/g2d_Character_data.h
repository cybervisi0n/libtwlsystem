...
typedef enum NNSG2dCharacterFmt {
  NNS_G2D_CHARACTER_FMT_CHAR, // Arranged for every 8*8 texel
...
NNS_G2D_INLINE u32 NNSi_G2dPackCharacterFmtData(NNSG2dCharacterFmt charFmt,
...
NNS_G2D_INLINE NNSG2dCharacterFmt
NNSi_G2dGetCharacterFmtType(u32 characterFmt) {
  return (NNSG2dCharacterFmt)(NNS_G2D_CHARACTER_FMT_MASK &
                              (characterFmt >> NNS_G2D_CHARACTER_FMT_SHIFT));
}

NNS_G2D_INLINE BOOL NNSi_G2dIsCharacterVramTransfered(u32 characterFmt) {
  return (BOOL)(NNS_G2D_VRAMTRANSFERDATA_FLAG_MASK &

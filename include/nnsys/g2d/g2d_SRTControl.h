...
void NNSi_G2dSrtcInitControl(NNSG2dSRTControl *pCtrl,
                             NNSG2dSRTControlType type);
void NNSi_G2dSrtcSetInitialValue(NNSG2dSRTControl *pCtrl);
void NNSi_G2dSrtcBuildMatrixFromSRT_2D(const NNSG2dSRTControl *pCtrl,
                                       MtxFx22 *pDst);
void NNSi_G2dSrtcBuildMatrixFromSRT_3D(const NNSG2dSRTControl *pCtrl,
                                       MtxFx22 *pDst);
...
NNS_G2D_INLINE void NNSi_G2dSrtcAffineFlagON(NNSG2dSRTControl *pSRT,
                                             u16 newFlag) {
  NNS_G2D_NULL_ASSERT(pSRT);
  NNS_G2D_ASSERT(pSRT->type == NNS_G2D_SRTCONTROLTYPE_SRT);
...
NNS_G2D_INLINE void NNSi_G2dSrtcAffineFlagOFF(NNSG2dSRTControl *pSRT,
                                              u16 newFlag) {
  NNS_G2D_NULL_ASSERT(pSRT);
  NNS_G2D_ASSERT(pSRT->type == NNS_G2D_SRTCONTROLTYPE_SRT);
  pSRT->srtData.SRT_EnableFlag &= ~(u16)newFlag;
...
NNS_G2D_INLINE BOOL NNSi_G2dSrtcIsAffineEnable(const NNSG2dSRTControl *pSRT,
                                               NNSG2dAffineEnable flag) {
  NNS_G2D_NULL_ASSERT(pSRT);
  NNS_G2D_ASSERT(pSRT->type == NNS_G2D_SRTCONTROLTYPE_SRT);
...
NNS_G2D_INLINE BOOL
NNSi_G2dSrtcIsAffineEnable_SR(const NNSG2dSRTControl *pSRT) {
  NNS_G2D_NULL_ASSERT(pSRT);
  NNS_G2D_ASSERT(pSRT->type == NNS_G2D_SRTCONTROLTYPE_SRT);

  return (NNSi_G2dSrtcIsAffineEnable(pSRT, NNS_G2D_AFFINEENABLE_SCALE) ||
          NNSi_G2dSrtcIsAffineEnable(pSRT, NNS_G2D_AFFINEENABLE_ROTATE))
             ? TRUE
             : FALSE;
}

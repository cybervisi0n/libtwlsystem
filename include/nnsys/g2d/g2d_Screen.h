...
#define NNS_G2D_BG_ASSERT(bg)                                                  \
  SDK_MINMAX_ASSERT(bg, NNS_G2D_BGSELECT_MAIN0, NNS_G2D_BGSELECT_NUM - 1)
...
NNS_G2D_INLINE GXBGColorMode
NNSi_G2dBGGetScreenColorMode(const NNSG2dScreenData *pScnData) {
...
NNS_G2D_INLINE NNSG2dScreenFormat
NNSi_G2dBGGetScreenFormat(const NNSG2dScreenData *pScnData) {
  NNS_G2D_POINTER_ASSERT(pScnData);
...
NNS_G2D_INLINE void NNS_G2dBGSetup(NNSG2dBGSelect bg,
                                   const NNSG2dScreenData *pScnData,
                                   const NNSG2dCharacterData *pChrData,
                                   const NNSG2dPaletteData *pPltData,
                                   GXBGScrBase scnBase, GXBGCharBase chrBase) {
  NNS_G2dBGSetupEx(bg, pScnData, pChrData, pPltData, NULL, NULL, scnBase,
                   chrBase);
}

NNS_G2D_INLINE void NNS_G2dBGLoadElements(NNSG2dBGSelect bg,
                                          const NNSG2dScreenData *pScnData,
                                          const NNSG2dCharacterData *pChrData,
                                          const NNSG2dPaletteData *pPltData) {

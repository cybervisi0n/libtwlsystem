...
#define NNS_G2D_CHARCANVAS_ASSERT(pCC)                                         \
  NNS_G2D_ASSERTMSG(NNS_G2D_IS_VALID_POINTER(pCC) && (0 < (pCC)->areaWidth) && \
                        (0 < (pCC)->areaHeight) &&                             \
...
#define NNS_G2D_256x16PLTT_BG_WIDTH_ASSERT(width)                              \
  NNS_G2D_ASSERTMSG((width) == NNS_G2D_256x16PLTT_BG_WIDTH_128 ||              \
...
typedef void (*NNSiG2dDrawGlyphFunc)(const struct NNSG2dCharCanvas *pCC,
                                     const NNSG2dFont *pFont, int x, int y,
                                     int cl, const NNSG2dGlyph *pGlyph);

typedef void (*NNSiG2dClearFunc)(const struct NNSG2dCharCanvas *pCC, int cl);

typedef void (*NNSiG2dClearAreaFunc)(const struct NNSG2dCharCanvas *pCC, int cl,
...
NNS_G2D_INLINE void NNS_G2dCharCanvasDrawGlyph(const NNSG2dCharCanvas *pCC,
                                               const NNSG2dFont *pFont, int x,
                                               int y, int cl,
...
NNS_G2D_INLINE void NNS_G2dCharCanvasClear(const NNSG2dCharCanvas *pCC,
                                           int cl) {
  NNS_G2D_CHARCANVAS_ASSERT(pCC);
  pCC->vtable->pClear(pCC, cl);
}

NNS_G2D_INLINE void NNS_G2dCharCanvasClearArea(const NNSG2dCharCanvas *pCC,
                                               int cl, int x, int y, int w,
                                               int h) {
  NNS_G2D_CHARCANVAS_ASSERT(pCC);
...
NNS_G2D_INLINE size_t
NNSi_G2dCharCanvasCalcCellDataSize(const NNSG2dCharCanvas *pCC, BOOL makeBR) {

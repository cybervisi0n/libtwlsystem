...
#define NNS_SND_STRM_THREAD_STACK_SIZE (1024 * 4)
...
typedef BOOL (*NNSSndArcStrmCallback)(NNSSndArcStrmCallbackStatus status,
...
BOOL NNS_SndArcStrmStart(struct NNSSndStrmHandle *handle, int strmNo,
                         u32 offset);
...
BOOL NNS_SndArcStrmStartEx(struct NNSSndStrmHandle *handle, int playerNo,
                           int playerPrio, int strmNo, u32 offset);
BOOL NNS_SndArcStrmPrepareEx(struct NNSSndStrmHandle *handle, int playerNo,
                             int playerPrio, int strmNo, u32 offset);
BOOL NNS_SndArcStrmStartEx2(struct NNSSndStrmHandle *handle, int playerNo,
                            int playerPrio, int strmNo, u32 offset,

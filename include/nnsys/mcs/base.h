...
typedef void (*NNSMcsRecvCallback)(const void *recv, u32 recvSize, u32 userData,
...
#define NNS_McsRegisterRecvCallback(pInfo, channel, cbFunc, userData)          \
  ((void)((void)((void)((void)((void)(pInfo), (channel)), (cbFunc)),           \
                 (userData)),                                                  \
          0))

#define NNS_McsRegisterStreamRecvBuffer(channel, buf, bufSize)                 \
  ((void)((void)((void)((void)(channel), (buf)), (bufSize)), 0))
...
#define NNS_McsReadStream(channel, data, size, pReadSize)                      \
  ((void)((void)((void)((void)(channel), (data)), (size)), (pReadSize)), FALSE)

#define NNS_McsGetStreamWritableLength(pLength) ((void)(pLength), FALSE)

#define NNS_McsWriteStream(channel, data, size)                                \
  ((void)((void)((void)(channel), (data)), (size)), FALSE)

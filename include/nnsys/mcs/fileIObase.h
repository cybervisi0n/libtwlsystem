...
#define NNS_McsFinalizeFileIO() ((void)0)

#define NNS_McsOpenFile(pFile, filename, openflag)                             \
  ((void)((void)((void)(pFile), (filename)), (openflag)),                      \
   NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsCloseFile(pFile) ((void)(pFile), NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsReadFile(pFile, buffer, length, pReadBytes)                     \
  ((void)((void)((void)((void)(pFile), (buffer)), (length)), (pReadBytes)),    \
   NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsWriteFile(pFile, buffer, length)                                \
  ((void)((void)((void)(pFile), (buffer)), (length)),                          \
   NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsSeekFile(pFile, distanceToMove, moveMethod, pNewFilePointer)    \
  ((void)((void)((void)((void)(pFile), (distanceToMove)), (moveMethod)),       \
          (pNewFilePointer)),                                                  \
   NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsFindFirstFile(pFile, pFindData, pattern)                        \
  ((void)((void)((void)(pFile), (pFindData)), (pattern)),                      \
   NNS_MCS_FILEIO_ERROR_COMERROR)

#define NNS_McsFindNextFile(pFile, pFindData)                                  \
  ((void)((void)(pFile), (pFindData)), NNS_MCS_FILEIO_ERROR_COMERROR)

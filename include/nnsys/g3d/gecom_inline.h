...
NNS_G3D_INLINE void NNS_G3dGePolygonAttr(int light, GXPolygonMode polyMode,
                                         GXCull cullMode, int polygonID,
                                         int alpha,
  ...
  tmp = GX_PACK_POLYGONATTR_PARAM(light, polyMode, cullMode, polygonID, alpha,
                                  misc);

  NNS_G3dGeBufferOP_N(G3OP_POLYGON_ATTR, &tmp, G3OP_POLYGON_ATTR_NPARAMS);
}

NNS_G3D_INLINE void NNS_G3dGeTexImageParam(GXTexFmt texFmt, GXTexGen texGen,
                                           GXTexSizeS s, GXTexSizeT t,
                                           GXTexRepeat repeat, GXTexFlip flip,
...
NNS_G3D_INLINE void NNS_G3dGeMaterialColorDiffAmb(GXRgb diffuse, GXRgb ambient,
                                                  BOOL IsSetVtxColor) {
  u32 tmp;
...
NNS_G3D_INLINE void NNS_G3dGeMaterialColorSpecEmi(GXRgb specular,
                                                  GXRgb emission,
                                                  BOOL IsShininess) {
  u32 tmp;
...
NNS_G3D_INLINE void NNS_G3dGeLightVector(GXLightId lightID, fx16 x, fx16 y,
                                         fx16 z) {
  u32 tmp;
...
NNS_G3D_INLINE void NNS_G3dGeBoxTest(const GXBoxTestParam *box) {
  ...
  NNS_G3dGeBufferOP_N(G3OP_BOX_TEST, (u32 *)&box->val[0],

...
typedef void (*NNSG3dAnimInitFunc)(NNSG3dAnmObj *, void *,
                                   const NNSG3dResMdl *);
...
typedef void (*NNSG3dFuncAnmMat)(NNSG3dMatAnmResult *, const NNSG3dAnmObj *,
                                 u32);

typedef void (*NNSG3dFuncAnmJnt)(NNSG3dJntAnmResult *, const NNSG3dAnmObj *,
                                 u32);

typedef void (*NNSG3dFuncAnmVis)(NNSG3dVisAnmResult *, const NNSG3dAnmObj *,
                                 u32);

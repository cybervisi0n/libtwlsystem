...
#define NNS_G3D_GET_JNTID(pMdl, pJntID, literal)                               \
  do {                                                                         \
    static const char name[NNS_G3D_UTIL_RESNAME_LEN] ATTRIBUTE_ALIGN(4) =      \
        literal;                                                               \
    *pJntID = NNS_G3dGetNodeIdxByName(NNS_G3dGetNodeInfo(pMdl),                \
                                      (NNSG3dResName *)name);                  \
  } while (0)
...
#define NNS_G3D_GET_MATID(pMdl, pMatID, literal)                               \
  do {                                                                         \
    static const char name[NNS_G3D_UTIL_RESNAME_LEN] ATTRIBUTE_ALIGN(4) =      \
        literal;                                                               \
    *pMatID =                                                                  \
        NNS_G3dGetMatIdxByName(NNS_G3dGetMat(pMdl), (NNSG3dResName *)name);    \
  } while (0)
...
#define NNS_G3D_GET_SHPID(pMdl, pShpID, literal)                               \
  do {                                                                         \
    static const char name[NNS_G3D_UTIL_RESNAME_LEN] ATTRIBUTE_ALIGN(4) =      \
        literal;                                                               \
    *pShpID =                                                                  \
        NNS_G3dGetShpIdxByName(NNS_G3dGetShp(pMdl), (NNSG3dResName *)name);    \
  } while (0)

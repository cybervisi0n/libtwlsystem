...
typedef void (*NNSGfdFrmPlttVramDebugDumpCallBack)(u32 loAddr, u32 hiAddr,
                                                   u32 szFree, u32 szTotal);
...
NNSGfdPlttKey NNS_GfdAllocFrmPlttVram(u32 szByte, BOOL b4Pltt,
                                      u32 bAllocFromLo);

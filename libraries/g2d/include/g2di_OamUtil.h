...
static u16 NNSi_G2dGetTextureBaseAddrOffs(u16 charIdx, GXTexSizeS sS,
                                          GXTexSizeT sT, u16 bytePerTexel);
...
static void
NNSi_G2dAdjustDifferenceOfRotateOrientation(const GXOamAttr *pOam,
                                            const MtxFx22 *pM, NNSG2dFVec2 *pV,
...
static const u16 NNSI_G2D_SIZE_OBJ_CHAR =
    NNSI_G2D_NNSI_G2D_SIZE_OBJ_CHAR_TEXEL_S *
    NNSI_G2D_NNSI_G2D_SIZE_OBJ_CHAR_TEXEL_T;
...
NNS_G2D_INLINE s16 NNSi_G2dGetOamX(const GXOamAttr *oamAttr) {
  ...
  {
    s16 val = (s16)((GX_OAM_ATTR01_X_MASK & oamAttr->attr01) >>
...
NNS_G2D_INLINE s16 NNSi_G2dGetOamY(const GXOamAttr *oamAttr) {
  NNS_G2D_NULL_ASSERT(oamAttr);
  {
    s16 val = (s16)((GX_OAM_ATTR01_Y_MASK & oamAttr->attr01) >>
...
NNS_G2D_INLINE u16 NNSi_G2dGetOamName(const GXOamAttr *oamAttr) {
  NNS_G2D_NULL_ASSERT(oamAttr);
  return (u16)((GX_OAM_ATTR2_NAME_MASK & oamAttr->attr2) >>
               GX_OAM_ATTR2_NAME_SHIFT);
}

NNS_G2D_INLINE u16 NNSi_G2dGetOamColorParam(const GXOamAttr *oamAttr) {
  NNS_G2D_NULL_ASSERT(oamAttr);
  return (u16)((GX_OAM_ATTR2_CPARAM_MASK & oamAttr->attr2) >>
               GX_OAM_ATTR2_CPARAM_SHIFT);
}
...
NNS_G2D_INLINE u16 NNSi_G2dGetOamAffineIdx(const GXOamAttr *oamAttr) {
  return (u16)((GX_OAM_ATTR01_RS_MASK & oamAttr->attr01) >>
...
NNS_G2D_INLINE BOOL NNSi_G2dIsVisible(const GXOamAttr *pOam) {
  ...
  return (0x2 != (GX_OAM_ATTR01_RSENABLE_MASK & pOam->attr0) >>
                     GX_OAM_ATTR01_RSENABLE_SHIFT)
             ? TRUE
             : FALSE;
}
...
NNS_G2D_INLINE u16 NNSi_G2dGetTextureBaseAddrOffs(u16 charIdx, GXTexSizeS sS,
                                                  GXTexSizeT sT,
                                                  u16 bytePerTexel) {
#pragma unused(sS)
#pragma unused(sT)
#pragma unused(bytePerTexel)
  ...
  NNS_G2D_MINMAX_ASSERT(
      retOffs, 0, bytePerTexel * NNSi_G2dGetTexelS(sS) * NNSi_G2dGetTexelT(sT));

  return retOffs;
}

NNS_G2D_INLINE u16 NNSi_G2dGetTextureU(u16 charIdx, GXTexSizeS sS) {
  const int numCharPerS =
      NNSi_G2dGetTexelS(sS) / NNSI_G2D_NNSI_G2D_SIZE_OBJ_CHAR_TEXEL_S;
...
NNS_G2D_INLINE u16 NNSi_G2dGetAffineIdx(const GXOamAttr *pOam) {
  if (NNSi_G2dIsRSEnable(pOam)) {
    return (u16)((pOam->attr01 & GX_OAM_ATTR01_RS_MASK) >>
                 GX_OAM_ATTR01_RS_SHIFT);
  } else {
...
NNS_G2D_INLINE void NNS_G2dGetOamTransFx32(const GXOamAttr *pOam,
                                           NNSG2dFVec2 *pRet) {
  NNS_G2D_NULL_ASSERT(pOam);
...
NNS_G2D_INLINE void
NNSi_G2dRemovePositionAdjustmentFromDoubleAffineOBJ(const GXOamAttr *pOam,
                                                    NNSG2dFVec2 *pV) {
  NNS_G2D_NULL_ASSERT(pOam);

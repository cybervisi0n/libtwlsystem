...
static void DrawSprite_(const NNSG2dSimpleSprite *pS,
                        const NNSG2dBasicSprite *pB,
                        const NNSG2dExtendedSprite *pE);
...

  {
    ...
    if (NNS_G2dIsSpriteAttrEnable(NNS_G2D_SPRITEATTR_TEXTURE)) {
      ...
      if (pB->pTextureAttr) {
        ...
        OS_Warning(
            "The Texture Attribute of software sprite must be specified.");
      }
    }
...
static void SetAffine43(MtxFx43 *pDst, const MtxFx22 *pSubMtx, fx32 x, fx32 y,
                        fx32 z) {
...
void NNS_G2dSetupSoftwareSpriteCamera() {
  G3_ViewPort(0, 0, 255, 191); // Viewport
  {
    ...
    {
      G3_OrthoW(FX32_ONE * 0, FX32_ONE * 192, FX32_ONE * 0, FX32_ONE * 256,
                FX32_ONE * -1024, FX32_ONE * 1024, FX32_ONE * 1024, NULL);
...
void NNS_G2dSetSpriteAttrEnable(u32 attr) { defaultAttrEnable_ = attr; }
...
void NNS_G2dDrawSpriteFast(s16 px, s16 py, int pz, int sx, int sy, int U0,
...
void NNSi_G2dDrawSpriteFast(s16 px, s16 py, fx32 pz, int sx, int sy, fx32 U0,
                            fx32 V0, fx32 U1, fx32 V1) {
...
void NNSi_G2dDrawSpriteWithMtxFast(s16 px, s16 py, fx32 pz, int sx, int sy,
                                   const MtxFx22 *baseMtx, fx32 U0, fx32 V0,
                                   fx32 U1, fx32 V1) {

  G3_Translate(FX32_ONE * px + FX32_HALF * sx, FX32_ONE * py + FX32_HALF * sy,
               pz);
...
void NNSi_G2dDrawSpriteWithMtxDoubleAffineFast(s16 px, s16 py, fx32 pz, int sx,
                                               int sy, const MtxFx22 *baseMtx,
                                               fx32 U0, fx32 V0, fx32 U1,
                                               fx32 V1) {

  G3_Translate(FX32_ONE * px + FX32_ONE * sx, FX32_ONE * py + FX32_ONE * sy,
               pz);

...
#ifndef SDK_FINALROM
const static char *sColorModeString[] = {"NNS_G2D_SCRCOLORMODE_16x16",
                                         "NNS_G2D_SCRCOLORMODE_256x1",
                                         "NNS_G2D_SCRCOLORMODE_256x16"};

const static char *sScreenFormatString[] = {
    "NNS_G2D_SCREENFORMAT_TEXT", "NNS_G2D_SCREENFORMAT_AFFINE",
    "NNS_G2D_SCREENFORMAT_AFFINEEXT", "NNS_G2D_SCREENFORMAT_PLTBMP",
    "NNS_G2D_SCREENFORMAT_DCBMP"};
#endif // SDK_FINALROM

BOOL NNS_G2dGetUnpackedScreenData(void *pNscrFile,
                                  NNSG2dScreenData **ppScrData) {
  NNS_G2D_NULL_ASSERT(pNscrFile);
  NNS_G2D_NULL_ASSERT(ppScrData);
  NNS_G2D_ASSERTMSG(NNS_G2dIsBinFileValid(pNscrFile,
                                          NNS_G2D_BINFILE_SIG_SCRDATA,
    ...
    NNSG2dBinaryFileHeader *pBinFile = (NNSG2dBinaryFileHeader *)pNscrFile;
    {
      NNSG2dScreenDataBlock *pBinBlk =
          (NNSG2dScreenDataBlock *)NNS_G2dFindBinaryBlock(
              pBinFile, NNS_G2D_BINBLK_SIG_SCRDATA);
      if (pBinBlk) {
        ...
        *ppScrData = &(pBinBlk->screenData);
        ...
        NNS_G2D_MINMAX_ASSERT((*ppScrData)->colorMode,
                              NNS_G2D_SCREENCOLORMODE_16x16,
                              NNS_G2D_SCREENCOLORMODE_256x16);
        NNS_G2D_MINMAX_ASSERT((*ppScrData)->screenFormat,

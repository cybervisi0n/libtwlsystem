...
static NNS_G2D_INLINE const NNSG2dCharWidths *
GetCharWidthsFromIndex(const NNSG2dFontWidth *const pWidth, int idx) {
...
void NNS_G2dFontInitAuto(NNSG2dFont *pFont, void *pNftrFile) {
  const static NNSiG2dSplitCharCallback spliterTable[] = {
      NNSi_G2dSplitCharUTF8, NNSi_G2dSplitCharUTF16, NNSi_G2dSplitCharShiftJIS,
...
NNSG2dTextRect NNSi_G2dFontGetTextRect(const NNSG2dFont *pFont, int hSpace,
  ...
  rect.height =
      ((lines - 1) * (NNS_G2dFontGetLineFeed(pFont) + vSpace) - vSpace);

...
static void DoTransfer3dClearImageColor(const void *pSrc, u32 /*offset*/,
                                        u32 szByte) {
...
static void DoTransfer3dClearImageDepth(const void *pSrc, u32 /*offset*/,
                                        u32 szByte) {
  GX_BeginLoadClearImage();
...
static void DoTransfer2dObjExtPlttMain(const void *pSrc, u32 offset,
                                       u32 szByte) {
...
static void DoTransfer2dBGExtPlttMain(const void *pSrc, u32 offset,
                                      u32 szByte) {
...
static void DoTransfer2dObjExtPlttSub(const void *pSrc, u32 offset,
                                      u32 szByte) {

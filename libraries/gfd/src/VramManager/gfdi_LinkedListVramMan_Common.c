...
GetRegionOfMemBlock_(NNSiGfdLnkMemRegion *pRegion,
...
static NNS_GFD_INLINE void
InitBlockFromRegion_(NNSiGfdLnkVramBlock *pBlk,
...
static NNS_GFD_INLINE void InitBlockFromPrams_(NNSiGfdLnkVramBlock *pBlk,
                                               u32 addr, u32 szByte) {
  NNS_GFD_NULL_ASSERT(pBlk);
...
static NNS_GFD_INLINE void InsertBlock_(NNSiGfdLnkVramBlock **pListHead,
...
static NNS_GFD_INLINE void RemoveBlock_(NNSiGfdLnkVramBlock **pListHead,
...
static BOOL TryToMergeBlockRegion_(NNSiGfdLnkVramMan *pMan,
...
void NNSi_GfdDumpLnkVramManFreeListInfo(
  ...
  NNSi_GfdDumpLnkVramManFreeListInfoEx(pBlk, DefaultDumpCallBack_,
                                       &szFreeTotal);
...

  {
    ...
    OS_Printf("    %08d / %08d bytes (%6.2f%%) used \n", szUsedTotal,
              szReserved, 100.f * szUsedTotal / szReserved);
  }
}
...
BOOL NNSi_GfdAllocLnkVram(NNSiGfdLnkVramMan *pMan,
                          ...
                          u32 szByte) {
  return NNSi_GfdAllocLnkVramAligned(pMan, ppBlockPoolList, pRetAddr, szByte,
                                     0);
}

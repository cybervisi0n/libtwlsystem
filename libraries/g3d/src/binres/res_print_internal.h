...
NNS_RES_PRINT void tabPlus_(void) NNS_RES_PRINT_END NNS_RES_PRINT
    void tabMinus_(void) NNS_RES_PRINT_END NNS_RES_PRINT
    void tabPrint_(void) NNS_RES_PRINT_END NNS_RES_PRINT
    void printFx32_(fx32 v) NNS_RES_PRINT_END NNS_RES_PRINT f32
    fx32Tof32_(fx32 v) NNS_RES_PRINT_END NNS_RES_PRINT
    void chkDict_(const NNSG3dResDict *dict, const NNSG3dResName *name,

...
void NNS_G3dMdlSetMdlDiff(NNSG3dResMdl *pMdl, u32 matID, GXRgb col) {
  ...
  data->diffAmb = (data->diffAmb & ~(REG_G3_DIF_AMB_DIFFUSE_RED_MASK |
                                     REG_G3_DIF_AMB_DIFFUSE_GREEN_MASK |
                                     REG_G3_DIF_AMB_DIFFUSE_BLUE_MASK)) |
...
void NNS_G3dMdlSetMdlAmb(NNSG3dResMdl *pMdl, u32 matID, GXRgb col) {
  ...
  data->diffAmb = (data->diffAmb & ~(REG_G3_DIF_AMB_AMBIENT_RED_MASK |
                                     REG_G3_DIF_AMB_AMBIENT_GREEN_MASK |
                                     REG_G3_DIF_AMB_AMBIENT_BLUE_MASK)) |
...
void NNS_G3dMdlSetMdlSpec(NNSG3dResMdl *pMdl, u32 matID, GXRgb col) {
  ...
  data->specEmi = (data->specEmi & ~(REG_G3_SPE_EMI_SPECULAR_RED_MASK |
                                     REG_G3_SPE_EMI_SPECULAR_GREEN_MASK |
                                     REG_G3_SPE_EMI_SPECULAR_BLUE_MASK)) |
...
void NNS_G3dMdlSetMdlEmi(NNSG3dResMdl *pMdl, u32 matID, GXRgb col) {
  ...
  data->specEmi = (data->specEmi & ~(REG_G3_SPE_EMI_EMISSION_RED_MASK |
                                     REG_G3_SPE_EMI_EMISSION_GREEN_MASK |
                                     REG_G3_SPE_EMI_EMISSION_BLUE_MASK)) |
...
void NNS_G3dMdlSetMdlLightEnableFlag(NNSG3dResMdl *pMdl, u32 matID, int light) {
  ...
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlLightEnableFlag is available only to "
                    "standard(default) materials");

  data->polyAttr = (data->polyAttr & ~REG_G3_POLYGON_ATTR_LE_MASK) |
                   (light << REG_G3_POLYGON_ATTR_LE_SHIFT);
}

void NNS_G3dMdlSetMdlPolygonMode(NNSG3dResMdl *pMdl, u32 matID,
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlPolygonMode is available only to "
                    "standard(default) materials");
...
void NNS_G3dMdlSetMdlCullMode(NNSG3dResMdl *pMdl, u32 matID, GXCull cullMode) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlCullMode is available only to "
                    "standard(default) materials");

  data->polyAttr = (data->polyAttr & ~(REG_G3_POLYGON_ATTR_BK_MASK |
...
void NNS_G3dMdlSetMdlPolygonID(NNSG3dResMdl *pMdl, u32 matID, int polygonID) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlPolygonID is available only to "
                    "standard(default) materials");
...
void NNS_G3dMdlSetMdlFogEnableFlag(NNSG3dResMdl *pMdl, u32 matID, BOOL flag) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlFogEnableFlag is available only to "
                    "standard(default) materials");
...
void NNS_G3dMdlSetMdlDepthTestCond(NNSG3dResMdl *pMdl, u32 matID, BOOL flag) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlDepthTestCond is available only to "
                    "standard(default) materials");
...
void NNS_G3dMdlSetMdlFarClip(NNSG3dResMdl *pMdl, u32 matID, BOOL flag) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlFarClip is available only to "
                    "standard(default) materials");
...
void NNS_G3dMdlSetMdlXLDepthUpdate(NNSG3dResMdl *pMdl, u32 matID, BOOL flag) {
  ...
  NNS_G3D_NULL_ASSERT(data);
  NNS_G3D_ASSERTMSG(data->itemTag == NNS_G3D_ITEMTAG_MAT_STANDARD,
                    "NNS_G3dMdlSetMdlXLDepthUpdate is available only to "
                    "standard(default) materials");
...
GXRgb NNS_G3dMdlGetMdlDiff(const NNSG3dResMdl *pMdl, u32 matID) {
  ...
  return (GXRgb)((data->diffAmb & (REG_G3_DIF_AMB_DIFFUSE_RED_MASK |
                                   REG_G3_DIF_AMB_DIFFUSE_GREEN_MASK |
                                   REG_G3_DIF_AMB_DIFFUSE_BLUE_MASK)) >>
...
GXRgb NNS_G3dMdlGetMdlAmb(const NNSG3dResMdl *pMdl, u32 matID) {
  ...
  return (GXRgb)((data->diffAmb & (REG_G3_DIF_AMB_AMBIENT_RED_MASK |
                                   REG_G3_DIF_AMB_AMBIENT_GREEN_MASK |
                                   REG_G3_DIF_AMB_AMBIENT_BLUE_MASK)) >>
...
GXRgb NNS_G3dMdlGetMdlSpec(const NNSG3dResMdl *pMdl, u32 matID) {
  ...
  return (GXRgb)((data->specEmi & (REG_G3_SPE_EMI_SPECULAR_RED_MASK |
                                   REG_G3_SPE_EMI_SPECULAR_GREEN_MASK |
                                   REG_G3_SPE_EMI_SPECULAR_BLUE_MASK)) >>
...
GXRgb NNS_G3dMdlGetMdlEmi(const NNSG3dResMdl *pMdl, u32 matID) {
  ...
  return (GXRgb)((data->specEmi & (REG_G3_SPE_EMI_EMISSION_RED_MASK |
                                   REG_G3_SPE_EMI_EMISSION_GREEN_MASK |
                                   REG_G3_SPE_EMI_EMISSION_BLUE_MASK)) >>
...
GXCull NNS_G3dMdlGetMdlCullMode(const NNSG3dResMdl *pMdl, u32 matID) {
  ...
  return (GXCull)((data->polyAttr & (REG_G3_POLYGON_ATTR_BK_MASK |
                                     REG_G3_POLYGON_ATTR_FR_MASK)) >>
...
void NNS_G3dMdlSetMdlPolygonModeAll(NNSG3dResMdl *pMdl,
                                    GXPolygonMode polyMode) {
  u32 matID;
  for (matID = 0; matID < pMdl->info.numMat; ++matID) {

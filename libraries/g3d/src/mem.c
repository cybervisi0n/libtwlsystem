...
NNSG3dRenderObj *NNS_G3dAllocRenderObj(NNSFndAllocator *pAlloc) {
  ...
  return (NNSG3dRenderObj *)NNS_FndAllocFromAllocator(pAlloc,
...
NNSG3dAnmObj *NNS_G3dAllocAnmObj(NNSFndAllocator *pAlloc, const void *pAnm,
...
NNSG3dJntAnmResult *NNS_G3dAllocRecBufferJnt(NNSFndAllocator *pAlloc,
  ...
  return (NNSG3dJntAnmResult *)NNS_FndAllocFromAllocator(
      pAlloc, NNS_G3D_RENDEROBJ_JNTBUFFER_SIZE(numJnt));
}
...
NNSG3dMatAnmResult *NNS_G3dAllocRecBufferMat(NNSFndAllocator *pAlloc,
  ...
  return (NNSG3dMatAnmResult *)NNS_FndAllocFromAllocator(
      pAlloc, NNS_G3D_RENDEROBJ_MATBUFFER_SIZE(numMat));
}

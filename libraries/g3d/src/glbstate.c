...
void NNS_G3dGlbInit(void) {
  ...
  NNS_G3dGlb.cmd0 = GX_PACK_OP(G3OP_MTX_MODE, G3OP_MTX_LOAD_4x4, G3OP_MTX_MODE,
                               G3OP_MTX_LOAD_4x3);
  NNS_G3dGlb.mtxmode_proj = GX_MTXMODE_PROJECTION;
  NNS_G3dGlb.mtxmode_posvec = GX_MTXMODE_POSITION_VECTOR;

  NNS_G3dGlb.cmd1 = GX_PACK_OP(G3OP_LIGHT_VECTOR, G3OP_LIGHT_VECTOR,
                               G3OP_LIGHT_VECTOR, G3OP_LIGHT_VECTOR);

  NNS_G3dGlb.cmd2 =
      GX_PACK_OP(G3OP_DIF_AMB, G3OP_SPE_EMI, G3OP_POLYGON_ATTR, G3OP_VIEWPORT);

  NNS_G3dGlb.cmd3 = GX_PACK_OP(G3OP_LIGHT_COLOR, G3OP_LIGHT_COLOR,
                               G3OP_LIGHT_COLOR, G3OP_LIGHT_COLOR);

  NNS_G3dGlb.cmd4 = GX_PACK_OP(G3OP_MTX_MULT_4x3, G3OP_MTX_SCALE,
                               G3OP_TEXIMAGE_PARAM, G3OP_NOP);

  MTX_Identity43(&NNS_G3dGlb.cameraMtx);
  MTX_Identity44(&NNS_G3dGlb.projMtx);

  NNS_G3dGlb.lightVec[0] =
      GX_PACK_LIGHTVECTOR_PARAM(0, -FX16_SQRT1_3, -FX16_SQRT1_3, -FX16_SQRT1_3);
  ...
  NNS_G3dGlb.prmMatColor0 =
      GX_PACK_DIFFAMB_PARAM(GX_RGB(16, 16, 16), GX_RGB(16, 16, 16), TRUE);
  NNS_G3dGlb.prmMatColor1 =
      GX_PACK_SPECEMI_PARAM(GX_RGB(16, 16, 16), GX_RGB(16, 16, 16), TRUE);

  NNS_G3dGlb.prmPolygonAttr =
      GX_PACK_POLYGONATTR_PARAM(0xf, // light ON
                                GX_POLYGONMODE_MODULATE, GX_CULL_BACK,
                                0,  // PolygonID
                                31, // alpha
...
void NNS_G3dGlbFlushP(void) {
  static const u32 sz =
      (sizeof(NNS_G3dGlb.cmd0) + sizeof(NNS_G3dGlb.mtxmode_proj) +
       sizeof(NNS_G3dGlb.projMtx) + sizeof(NNS_G3dGlb.mtxmode_posvec) +
       sizeof(NNS_G3dGlb.cameraMtx) + sizeof(NNS_G3dGlb.cmd1) +
       sizeof(NNS_G3dGlb.lightVec[0]) * 4 + sizeof(NNS_G3dGlb.cmd2) +
       sizeof(NNS_G3dGlb.prmMatColor0) + sizeof(NNS_G3dGlb.prmMatColor1) +
       sizeof(NNS_G3dGlb.prmPolygonAttr) + sizeof(NNS_G3dGlb.prmViewPort) +
       sizeof(NNS_G3dGlb.cmd4) + sizeof(NNS_G3dGlb.prmBaseTrans) +
       sizeof(NNS_G3dGlb.prmBaseRot) + sizeof(NNS_G3dGlb.prmBaseScale) +
       sizeof(NNS_G3dGlb.prmTexImageParam) + sizeof(NNS_G3dGlb.cmd3) +
       sizeof(NNS_G3dGlb.lightColor[0]) * 4) /
      4;

  NNS_G3D_ASSERT(NNS_G3dGlb.cmd0 ==
                 ((G3OP_MTX_MODE << 0) | (G3OP_MTX_LOAD_4x4 << 8) |
                  (G3OP_MTX_MODE << 16) | (G3OP_MTX_LOAD_4x3 << 24)));
  ...
  NNS_G3D_ASSERT(NNS_G3dGlb.cmd1 ==
                 ((G3OP_LIGHT_VECTOR << 0) | (G3OP_LIGHT_VECTOR << 8) |
                  (G3OP_LIGHT_VECTOR << 16) | (G3OP_LIGHT_VECTOR << 24)));
  NNS_G3D_ASSERT(NNS_G3dGlb.cmd2 ==
                 ((G3OP_DIF_AMB << 0) | (G3OP_SPE_EMI << 8) |
                  (G3OP_POLYGON_ATTR << 16) | (G3OP_VIEWPORT << 24)));
  NNS_G3D_ASSERT(NNS_G3dGlb.cmd3 ==
                 ((G3OP_LIGHT_COLOR << 0) | (G3OP_LIGHT_COLOR << 8) |
                  (G3OP_LIGHT_COLOR << 16) | (G3OP_LIGHT_COLOR << 24)));
  NNS_G3D_ASSERT(NNS_G3dGlb.cmd4 ==
                 ((G3OP_MTX_MULT_4x3 << 0) | (G3OP_MTX_SCALE << 8) |
...
void NNS_G3dGlbFlushVP(void) {
  static const u32 sz =
      (sizeof(NNS_G3dGlb.cmd1) + sizeof(NNS_G3dGlb.lightVec[0]) * 4 +
       sizeof(NNS_G3dGlb.cmd2) + sizeof(NNS_G3dGlb.prmMatColor0) +
       sizeof(NNS_G3dGlb.prmMatColor1) + sizeof(NNS_G3dGlb.prmPolygonAttr) +
       sizeof(NNS_G3dGlb.prmViewPort) + sizeof(NNS_G3dGlb.cmd3) +
       sizeof(NNS_G3dGlb.lightColor[0]) * 4 + sizeof(NNS_G3dGlb.cmd4) +
       sizeof(NNS_G3dGlb.prmBaseRot) + sizeof(NNS_G3dGlb.prmBaseTrans) +
       sizeof(NNS_G3dGlb.prmBaseScale) + sizeof(NNS_G3dGlb.prmTexImageParam)) /
      4;
  ...
  NNS_G3dGeBufferOP_N((G3OP_MTX_MULT_4x3 << 0), (u32 *)&NNS_G3dGlb.cameraMtx,
...
void NNS_G3dGlbMaterialColorDiffAmb(GXRgb diffuse, GXRgb ambient,
                                    BOOL IsSetVtxColor) {
  GXRGB_ASSERT(diffuse);
  GXRGB_ASSERT(ambient);

  NNS_G3dGlb.prmMatColor0 =
      GX_PACK_DIFFAMB_PARAM(diffuse, ambient, IsSetVtxColor);
}

void NNS_G3dGlbMaterialColorSpecEmi(GXRgb specular, GXRgb emission,
                                    BOOL IsShininess) {
  GXRGB_ASSERT(specular);
  GXRGB_ASSERT(emission);

  NNS_G3dGlb.prmMatColor1 =
      GX_PACK_SPECEMI_PARAM(specular, emission, IsShininess);
}

void NNS_G3dGlbPolygonAttr(int light, GXPolygonMode polyMode, GXCull cullMode,
                           int polygonID, int alpha,
  ...
  NNS_G3dGlb.prmPolygonAttr = GX_PACK_POLYGONATTR_PARAM(
      light, polyMode, cullMode, polygonID, alpha, misc);
}
...
const MtxFx43 *NNS_G3dGlbGetInvW(void) {
  if (!(NNS_G3dGlb.flag & NNS_G3D_GLB_FLAG_INVBASE_UPTODATE)) {
    MtxFx43 tmp;
    s32 result;
    MTX_ScaleApply43((MtxFx43 *)&NNS_G3dGlb.prmBaseRot, &tmp,
                     NNS_G3dGlb.prmBaseScale.x, NNS_G3dGlb.prmBaseScale.y,
...
static void calcSrtCameraMtx_(void) {
  ...
  MTX_Concat43((MtxFx43 *)&NNS_G3dGlb.prmBaseRot, &NNS_G3dGlb.cameraMtx,
               &NNS_G3dGlb.srtCameraMtx);
  MTX_ScaleApply43(&NNS_G3dGlb.srtCameraMtx, &NNS_G3dGlb.srtCameraMtx,
                   NNS_G3dGlb.prmBaseScale.x, NNS_G3dGlb.prmBaseScale.y,
                   NNS_G3dGlb.prmBaseScale.z);

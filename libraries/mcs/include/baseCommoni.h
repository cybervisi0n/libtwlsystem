...
#define NNSi_MCS_ENS_READ_RB_END                                               \
  (NNSi_MCS_ENS_READ_RB_START + NNSi_MCS_ENS_READ_RB_SIZE)

#define NNSi_MCS_ENS_WRITE_RB_SIZE NNSi_MCS_ENS_READ_RB_SIZE
#define NNSi_MCS_ENS_WRITE_RB_START NNSi_MCS_ENS_READ_RB_END
#define NNSi_MCS_ENS_WRITE_RB_END                                              \
  (NNSi_MCS_ENS_WRITE_RB_START + NNSi_MCS_ENS_WRITE_RB_SIZE)
